...
st.caption("Powered by LangChain + Groq — turn a rough idea into a polished LinkedIn post in seconds.")
...
USER_PROMPT_TEMPLATE = """Write a LinkedIn post of type '{category}'.
Tone: {tone}.
Length: {length_desc}.
